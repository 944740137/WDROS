...
#include <franka_gazebo/pseudo_inversion.h>
...
void FrankaHWSim::updateRobotState(ros::Time time) {
  ...
  franka_pseudoInverse::pseudoInverse(j0.transpose(), j0_transpose_pinv);
  franka_pseudoInverse::pseudoInverse(jk.transpose(), jk_transpose_pinv);
